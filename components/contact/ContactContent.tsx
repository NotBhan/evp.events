              ...
              <div className="relative z-10 pt-4 border-t border-antique-gold/20 space-y-2">
                ...
                {eventData.socialLinks.map((social) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full inline-flex items-center justify-between py-2.5 px-3.5 rounded-lg bg-royal-maroon/70 hover:bg-royal-maroon text-bright-gold border border-antique-gold/30 hover:border-bright-gold text-xs font-body font-semibold transition-colors"
                  >
                ...
                <span className="block text-center font-body text-[11px] text-warm-cream/65 pt-1">
                  Official Festival Inquiries &amp; Social
                </span>
              </div>
            </div>
              ...
              <div className="relative z-10">
                ...
                <div className="mt-8 pt-5 border-t border-antique-gold/25 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 text-xs font-body text-warm-cream/75">
                  ...
                  <div className="text-antique-gold/90 italic text-xs">
                    Celebration Venue: Upwan Lawn, Chanakya BNR Hotel (Distinct from the principal place of business)
                  </div>
                </div>
              </div>
            </div>
